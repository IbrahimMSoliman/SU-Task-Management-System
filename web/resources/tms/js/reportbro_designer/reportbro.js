    ...
    (0, _createClass3.default)(PopupWindow, [{
        ...
        value: function show(items, objId, tagId, field, type) {
            ...
            if (type === PopupWindow.type.testData) {
                ...
                for (var _i = 0; _i < sis_parameters.length; _i++) 
                    {
                    _loop(sis_parameters[_i]);
                    }
                } catch (err) {
                    _didIteratorError = true;
                    _iteratorError = err;
        ...
        value: function filterParameters(searchVal) {
            ...
            if (this.items !== null) {
                ...
                try {
                    ...
                    for(let i = 0;i < sis_parameters.length;i++)
                    {
                        var _item = sis_parameters[i];//_step7.value;
                            ...
                            if (!(event.target instanceof HTMLInputElement || event.target instanceof HTMLTextAreaElement)) {
                                ...
                                try {
                                    for (var _iterator5 = (0, _getIterator3.default)(_this.clipboardElements), _step5; !(_iteratorNormalCompletion5 = (_step5 = _iterator5.next()).done); _iteratorNormalCompletion5 = true) {
                                        var _clipboardElement2 = _step5.value;
                                ...
                                if (!cmdGroup.isEmpty()) {
                                    ...
                                    try {
                                        for (var _iterator6 = (0, _getIterator3.default)(_this.clipboardElements), _step6; !(_iteratorNormalCompletion6 = (_step6 = _iterator6.next()).done); _iteratorNormalCompletion6 = true) {
                                            var clipboardElement = _step6.value;
...
var locale_en = {
    ...
    menuSave: 'SAVE',
    menuSaveTip: 'Save Letter Template',
...
var MainPanel = function () {
    function MainPanel(rootElement, headerBand, contentBand, footerBand, parameterContainer, styleContainer, rb) {
        ...
        this.stylesItem = new _MainPanelItem2.default('style', null, styleContainer, { hasChildren: true, showAdd: false, showDelete: false, hasDetails: false }, rb);
    ...
    (0, _createClass3.default)(MenuPanel, [{
        ...
        value: function render() {
            ...
            if (this.rb.getProperty('menuShowDebug')) {
             ...
             panelLeft.append($('<button id="rbro_menu_preview" type="submit" class="rbroButton rbroMenuButton" title="' + this.rb.getLabel('menuPreviewTip') + '">\n          <span class="rbroIcon-play"></span><span class="' + menuButtonClass + '">' + this.rb.getLabel('menuPreview') + '</span></button>').click(function (event) {
               // _this.rb.preview();
               update_and_preview(); 
               return false;
            }));
